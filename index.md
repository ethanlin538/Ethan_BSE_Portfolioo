...
PAN = 1   # bottom servo -> left/right
TILT = 0  # top servo -> up/down
PAN_TILT_STEP = 5
...
# ------------------------------------------------------------------
# Gesture recognition (OpenCV-only)
# ------------------------------------------------------------------
...
try:
    while True:
          ...
          # --- gesture check (only runs while enabled) ---
          frame_counter += 1
          gesture_dt = 0.0
